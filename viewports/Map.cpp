...
void Map::paint() {
  ...
  SDL_Rect mapViewport = {
    static_cast<int>(
      round(static_cast<double>(MAIN_SCREEN_BASE_MAP_X) * wScale)),
    static_cast<int>(
      round(static_cast<double>(MAIN_SCREEN_BASE_MAP_Y) * hScale)),
    static_cast<int>(
      round(static_cast<double>(MAIN_SCREEN_BASE_MAP_W) * wScale)),
    static_cast<int>(
      round(static_cast<double>(MAIN_SCREEN_BASE_MAP_H) * hScale))
  };
